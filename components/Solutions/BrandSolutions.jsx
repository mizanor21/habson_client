  ...
  return (
    <section className="px-[5%] xl:pt-5 md:pb-20 bg-white relative z-[110] rounded-b-[70px] font-sora">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10 lg:mb-20">
        {/* Left Side */}
        <div>
          <h2 className="text-[24px] md:text-4xl lg:text-[48px] text-[#0066B3] font-bold mb-5 md:mb-10 transition duration-300 ease-in-out transform">
            Brand Solutions
          </h2>
          ...
          <p className="font-semibold text-[18px] text-[#0066B3] mb-10 transition-opacity duration-300 ease-in-out">
