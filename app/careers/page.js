    ...
    <div className="relative bg-white z-[110] rounded-b-[20px] lg:rounded-b-[60px]">
      <div className="px-[5%] ">
        ...
        <div className="2xl:text-center font-sora py-[20px] md:pt-[45px] 2xl:py-[70]">
          <h1 className="text-[#0066B3] text-[24px] font-[600] mt-0 lg:mt-10">
            Have you got what it takes to #CreateAHabson?
          </h1>
          <p className="text-[#0066B3] font-[600] 2xl:font-[400] text-[24px] 2xl:text-[19px] mt-2">
